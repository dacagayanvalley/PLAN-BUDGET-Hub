...
const tables = {
  ...
  bulk_import_templates: seedData.bulkTemplates.map((template) => ({
    ...
    allow_multiple_programs: template.allowsMultiplePrograms ? "TRUE" : "FALSE",
    allow_multiple_offices: template.allowsMultipleOffices ? "TRUE" : "FALSE",
    program_detection: template.programDetection || "",
  })),
